...
export const handleLessThanCondition = (question: Question, filterValue: string | number): boolean => {
  ...
  console.warn(`Cannot compare values for less_than condition. Question ID: ${question.id}, Type: ${question.type}`);
  return false;
};
